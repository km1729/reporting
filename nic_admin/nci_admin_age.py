...
parser.add_argument('-j', '--job', dest='job', default="display", help='display/update')
...
if user == "all":
    ...
    if job == "display":
        ...
        print("Updating your aged file profile. It may take a while...")
        process_age_left(age_file, age_file_left, user, proj)            
